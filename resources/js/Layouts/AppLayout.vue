<template>
    <div class="h-screen flex overflow-hidden bg-default">
        ...
        <div x-show="sidebarOpen" class="md:hidden">
            <div @click="sidebarOpen = false" class="fixed inset-0 z-30 transition-opacity ease-linear duration-300">
                <div class="absolute inset-0 bg-gray-600 opacity-75"></div>
            </div>
            <div class="fixed inset-0 flex z-40">
                <div class="flex-1 flex flex-col max-w-xs w-full bg-indigo-800 transform ease-in-out duration-300 ">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <div class="flex-shrink-0 flex items-center px-4">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="140" height="61" viewBox="0 0 140 61">
                                <defs>
                                    <linearGradient id="ci8f2z78qb" x1="100%" x2="100%" y1="2.765%" y2="135.902%">
                                        <stop offset="0%" stop-color="#7D7E79"/>
                                        <stop offset="100%" stop-color="#FFFCF8"/>
                                    </linearGradient>
                                    <linearGradient id="bvyl8gq80d" x1="28.935%" x2="80.111%" y1="37.783%" y2="81.956%">
                                        <stop offset="0%" stop-color="#6B6B6A"/>
                                        <stop offset="100%" stop-color="#92928E"/>
                                    </linearGradient>
                                    <linearGradient id="au07qmy1fe" x1="51.722%" x2="45.505%" y1="11.457%" y2="94.07%">
                                        <stop offset="0%" stop-color="#B5B5B1"/>
                                        <stop offset="100%" stop-color="#E4E3DF"/>
                                    </linearGradient>
                                    <linearGradient id="9sqhwc738g" x1="27.031%" x2="90.987%" y1="60.894%" y2="-41.779%">
                                        <stop offset="0%" stop-color="#BCB6AA"/>
                                        <stop offset="100%" stop-color="#F6F5EF"/>
                                    </linearGradient>
                                    <linearGradient id="j64ohv5rcj" x1="99.982%" x2="99.982%" y1="5.809%" y2="104.162%">
                                        <stop offset="0%" stop-color="#EAE6DF"/>
                                        <stop offset="100%" stop-color="#BCB6AA"/>
                                    </linearGradient>
                                    <path id="apowalukla" d="M7.144 29.764c.05-2.804.808-3.417 1.939-4.376.843-.715 1.412-1.273 1.462-3.599.071-3.285-3.074-5.453-5.516-5.516-2.732-.07-4.494 1.968-5.015 3.216C3.628 10.247 14.79.477 15.202.022 17.436 9.714 25.261 18.24 27.967 19.87 18.15 31.938 10.11 51.24 6.738 60.033H6.5V30.408c.411 0 .636-.232.644-.644"/>
                                    <path id="fw1inhwcxf" d="M33.17.712c.215.442-9.492 7.19-15.263 19.67-2.921 6.316-4.703 13.903-3.947 23.286l-.78-1.607C9.505 34.577 5.01 26.66.064 20.58c2.708-1.63 10.542-10.167 12.77-19.867C16.224.316 19.613.087 23.002.07c3.39.016 6.78.245 10.169.64"/>
                                    <path id="x3bt9qjd3i" d="M3.773 2.64c.013 4.632 3.444 2.336 3.398 7.732-.003.411.233.644.644.644V40.64h-.238C5.904 36.278 3.862 30.936.243 23.567-.398 16.602.673 6.5 4.271.097c-.39.828-.501 1.567-.498 2.544"/>
                                </defs>
        ...
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64 bg-semilight">
                <div class="h-0 flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-16 flex-1 px-2 bg-semilight flex flex-col items-center">
<!--                        <a href="/user/profile"-->
<!--                           class="w-48 group flex items-center px-2 py-2 text-sm leading-5 font-medium rounded-md focus:outline-none transition ease-in-out duration-150 text-color-inactive">-->
<!--                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" class="mr-12 h-5 w-5 text-color-active group-focus:text-indigo-300 transition ease-in-out duration-150">-->
<!--                                <g fill="none" fill-rule="evenodd">-->
...
<!--                        </a>-->
                        <a href="#"
                           class="mt-10 w-48 group flex items-center px-2 py-2 leading-5 font-medium text-white rounded-md focus:outline-none transition ease-in-out duration-150 text-color-active">
                            <svg
                                class="mr-12 h-5 w-5 text-color-active group-focus:text-indigo-300 transition ease-in-out duration-150"
                                stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
                            </svg>
                        ...
                        <form @submit.prevent="logout" class="mt-10 w-48">
                            <button type="submit"
                               class="mt-1 group flex items-center px-2 py-2 leading-5 font-medium text-color-inactive hover:text-color-active rounded-md focus:outline-none transition ease-in-out duration-150">
                                <svg
                                    class="mr-12 h-5 w-5 text-color-inactive transition ease-in-out duration-150"
                                    stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                          d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                </svg>
                ...
                <div class="flex-shrink-0 flex pt-4 pb-8 px-10">
                    <a href="/user/profile" class="flex-shrink-0 group block focus:outline-none">
                        <div class="flex items-center">
                            ...
                            <div class="ml-8">
                                <p v-if="$page.user.pen_name" class="text-md leading-5 font-bold text-color-dark">
                                    {{ $page.user.pen_name }}
                                </p>
                                <p v-else class="text-md leading-5 font-bold text-color-dark">
                                    {{ $page.user.name }}
                                </p>
                            </div>
                        </div>
